...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        CType(dgvBantuan, ComponentModel.ISupportInitialize).BeginInit()
        CType(ErrorProvider1, ComponentModel.ISupportInitialize).BeginInit()
        SuspendLayout()
        ' 
        ' dgvBantuan
        ' 
        dgvBantuan.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize
        dgvBantuan.Location = New Point(12, 418)
        dgvBantuan.Name = "dgvBantuan"
        dgvBantuan.RowHeadersWidth = 51
        dgvBantuan.Size = New Size(1085, 184)
        dgvBantuan.TabIndex = 0
        ' 
        ' txtSearch
        ' 
        ...
        ' txtJumlah
        ' 
        txtJumlah.Font = New Font("Sylfaen", 10.2F)
        txtJumlah.Location = New Point(174, 368)
        txtJumlah.Name = "txtJumlah"
        txtJumlah.PlaceholderText = "Nominal"
        txtJumlah.Size = New Size(377, 30)
        ...
        ' txtRekening
        ' 
        txtRekening.Font = New Font("Sylfaen", 10.2F)
        txtRekening.Location = New Point(376, 268)
        txtRekening.Name = "txtRekening"
        txtRekening.PlaceholderText = "Nomor Rekening"
        txtRekening.Size = New Size(175, 30)
        txtRekening.TabIndex = 20
        ' 
        ' btnUbah
        ' 
        ...
        Controls.Add(dgvBantuan)
        Name = "Form1"
        Text = "Form1"
        CType(dgvBantuan, ComponentModel.ISupportInitialize).EndInit()
        CType(ErrorProvider1, ComponentModel.ISupportInitialize).EndInit()
        ResumeLayout(False)
        PerformLayout()
    End Sub

    Friend WithEvents dgvBantuan As DataGridView
